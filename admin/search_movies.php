...
foreach ($groupedMovies as $movie): 
    ...
    <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg">
        ...
        <div class="p-4">
            ...
            <button type="button" class="btn bg-yellow-400 text-black font-medium hover:bg-yellow-300 p-2 rounded-2xl mt-3">
                <a href="uploads/<?= htmlspecialchars($row['trailer']) ?>" target="_blank">Watch Trailer</a>
            </button>
            <a href="uploads/<?= htmlspecialchars($row['movie']) ?>" target="_blank"
